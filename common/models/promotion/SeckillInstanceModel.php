...
use common\models\promotion\SeckillGoodsModel;

/*
	秒杀实例模型
*/
class SeckillInstanceModel extends BaseModel
{
	public static function tableName()
	{
		return '{{%seckill_instance}}';
	}
	...
	public function rules()
	{
		return [
			...
			[['start_time','end_time','trailer_time','update_time'],'integer'],
			[['title','start_time','end_time','trailer_time'],'required'],
		];
	}
