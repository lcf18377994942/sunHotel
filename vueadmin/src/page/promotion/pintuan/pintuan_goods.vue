<template>
    <div>
	 	<div class="container" style="border: none;">
            <el-page-header @back="backPintuan" content="拼团商品管理" style="margin-bottom: 20px;">
            </el-page-header>
...
export default{
	...
	methods:{
		getData() {
            ...
            this.$post_('promotion/pintuan/instance_goods_list',params,(res) =>{
                this.ifload = false;
                if(res.code=='0'){
                    this.list = res.data;
                }else{
        ...
        chooseEmit(goods) {
            ...
            this.ifload = true;
            this.$post_('promotion/pintuan/add_instance_goods',params,(res) =>{
                this.ifload = false;
		...
		delData() {
			...
			this.$post_('promotion/pintuan/del_instance_goods',param,(res) => {
				console.log(res);
				if(res.code=='0'){
					this.$message.success(res.msg);
