...
Source Database       : shopfx_db

Target Server Type    : MYSQL
Target Server Version : 50721
File Encoding         : 65001

Date: 2020-02-16 23:28:20
*/
...
CREATE TABLE `address` (
  ...
  `province_id` mediumint(9) DEFAULT '0' COMMENT '省级id',
  ...
  `is_default` char(1) NOT NULL DEFAULT '0' COMMENT '1默认收货地址',
  PRIMARY KEY (`address_id`),
  KEY `member_id` (`member_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=45074 DEFAULT CHARSET=utf8 COMMENT='地区表';
...
CREATE TABLE `article` (
  ...
  `class_id` int(11) DEFAULT NULL COMMENT '公告分类ID',
  `title` varchar(32) DEFAULT NULL COMMENT '标题',
  `desc` varchar(128) DEFAULT NULL COMMENT '简介',
  `logo` varchar(200) DEFAULT NULL COMMENT 'logo图片',
  `content` text COMMENT '内容',
  `state` char(1) DEFAULT '1' COMMENT '1显示 0不显示',
...
CREATE TABLE `balance` (
  ...
  `is_tixian` char(1) NOT NULL DEFAULT '0' COMMENT '是否可以体现',
  `is_transfer` char(1) NOT NULL DEFAULT '0' COMMENT '是否可以转账',
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '有效开始时间',
...
CREATE TABLE `balance_log` (
  ...
  `balance_id` int(11) DEFAULT NULL COMMENT '账本标识',
  `balance_type` int(11) DEFAULT NULL COMMENT '账本类型',
  `source_type` int(2) DEFAULT '0' COMMENT '//来源类型\r\n1,会员转帐 2交易卖出,3交易买入 4兑换',
  `log_type` int(2) DEFAULT NULL COMMENT '日志类型（增加1、减少0）',
  `source_id` bigint(20) DEFAULT NULL COMMENT '如果来源为订单，即为订单id,如果来源为分红，则为分红日志id',
  `old_balance` decimal(11,4) DEFAULT '0.0000' COMMENT '上次金额',
  `note` text COMMENT '备注',
  `bonus_from` varchar(64) DEFAULT NULL COMMENT '分红的来源',
...
CREATE TABLE `balance_operate` (
  ...
  `balance_type` tinyint(4) DEFAULT NULL COMMENT '账本类型',
  `type` char(1) DEFAULT NULL COMMENT '类型 1增加 2减少',
  `remark` varchar(64) DEFAULT NULL COMMENT '备注',
  `operator` varchar(32) DEFAULT '' COMMENT '操作人',
  `create_time` int(11) DEFAULT NULL COMMENT '创建时间',
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='账本操作';

-- ----------------------------
-- Records of balance_operate
-- ----------------------------
...
CREATE TABLE `balance_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL DEFAULT '0' COMMENT '账本类型',
  `type_name` varchar(32) NOT NULL COMMENT '账本类型名称',
  `is_tixian` char(1) NOT NULL DEFAULT '0' COMMENT '能否提现',
  `is_transfer` char(1) DEFAULT '0' COMMENT '能否转账',
  `is_edit` char(1) DEFAULT '0' COMMENT '能否在后台操作',
...
CREATE TABLE `banner` (
  ...
  `type` char(1) DEFAULT '1' COMMENT '类型 如 1商城，用来定义不同页面的轮播图片',
  `link` varchar(128) DEFAULT NULL COMMENT '链接地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='轮播图';
...
CREATE TABLE `cart` (
  ...
  `type` char(1) DEFAULT '1' COMMENT '1加入购物车购买（默认） 2直接购买',
  `goods_image` varchar(100) NOT NULL COMMENT '商品图片',
  PRIMARY KEY (`cart_id`),
  KEY `member_id` (`buyer_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';
...
CREATE TABLE `coupons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coupons_instance_id` int(11) NOT NULL COMMENT '优惠券实例id',
  `coupons_money` decimal(10,2) DEFAULT '0.00' COMMENT '优惠券金额',
  `member_id` int(11) DEFAULT NULL COMMENT '领取优惠券的会员id',
  `order_id` int(11) DEFAULT NULL COMMENT '使用优惠券的订单id',
  `end_time` int(11) DEFAULT '0' COMMENT '优惠券有效期止时间',
  `state` char(1) NOT NULL DEFAULT '1' COMMENT '状态 1未用 2已用 3过期 4失效',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `coupons_instance` (
  `instance_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '优惠券名称',
  `coupons_name` varchar(32) NOT NULL COMMENT '优惠券名称',
  `coupons_desc` varchar(128) DEFAULT NULL COMMENT '优惠券描述',
  `get_type` char(1) NOT NULL DEFAULT '1' COMMENT '领取方式 1免费领取 ...',
  `type` char(1) NOT NULL DEFAULT '1' COMMENT '1 满减券 2折扣券',
  `time_type` char(1) NOT NULL DEFAULT '1' COMMENT '时间类型 1时间段 2 N天后有效',
  `start_time` int(11) NOT NULL COMMENT '优惠券开始时间',
  `end_time` int(11) NOT NULL COMMENT '优惠券结束时间',
  `useful_day` tinyint(4) DEFAULT '0' COMMENT '有效天数',
  `discount` decimal(6,1) DEFAULT '0.0' COMMENT '优惠折扣',
  `coupons_money` decimal(8,2) NOT NULL DEFAULT '0.00' COMMENT '优惠券面额',
  `total_nums` tinyint(8) NOT NULL COMMENT '发放总数',
  `limit_nums` tinyint(4) NOT NULL COMMENT '每人限领数量',
  `giveout_nums` tinyint(4) DEFAULT '0' COMMENT '已发放数量',
  `consume_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '消费金额可用',
  `coupons_image` varchar(128) DEFAULT NULL COMMENT '优惠券图片',
  `use_type` char(1) DEFAULT '1' COMMENT '可用类型 1通用券 2分类下使用 3单品使用',
  `type_id` int(11) DEFAULT '0' COMMENT '类型对应的id 分类为产品分类id 单品为产品id',
  `state` char(1) DEFAULT '1' COMMENT '状态 1有效 0失效',
  `create_time` int(10) DEFAULT NULL,
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`instance_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='优惠券实例';

-- ----------------------------
-- Records of coupons_instance
-- ----------------------------
...
CREATE TABLE `evaluate_goods` (
  ...
  `goods_commonid` int(11) NOT NULL COMMENT '商品共公id',
  `goods_name` varchar(100) NOT NULL COMMENT '商品名称',
  ...
  `member_id` int(11) NOT NULL COMMENT '评价人ID',
  `member_name` varchar(100) DEFAULT NULL COMMENT '评价人名称',
  `member_avatar` varchar(128) DEFAULT NULL COMMENT '评价人头像',
  `explain` varchar(255) DEFAULT NULL COMMENT '商家回复',
  `eval_image` varchar(255) DEFAULT NULL COMMENT '晒单图片',
  `content_again` varchar(255) DEFAULT NULL COMMENT '追加评价内容',
  `eval_addtime_again` int(10) unsigned DEFAULT NULL COMMENT '追加评价时间',
  `eval_image_again` varchar(255) DEFAULT NULL COMMENT '追加评价图片',
  `explain_again` varchar(255) DEFAULT NULL COMMENT '追加解释内容',
  `eval_top` tinyint(1) DEFAULT '100' COMMENT '置顶',
  `eval_top_time` int(10) unsigned DEFAULT NULL COMMENT '置顶时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `express` (
  ...
  `e_chose` char(1) DEFAULT '0' COMMENT '是否为常用快递 1是',
  UNIQUE KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='快递公司';
...
CREATE TABLE `fx_auth_rule` (
  ...
  `type` char(1) DEFAULT '1' COMMENT '1内部 2外部',
  `is_menu` char(1) DEFAULT '1' COMMENT '是否为菜单 1是',
...
CREATE TABLE `fx_role` (
  ...
  `rule_ids` text COMMENT '菜单id 用,隔开',
  `role_desc` varchar(64) DEFAULT NULL COMMENT '角色描述',
  `uid` int(11) DEFAULT NULL COMMENT '创建人id 对应admin表中的',
  `status` char(1) DEFAULT '1' COMMENT '状态 1正常',
  `create_time` int(10) DEFAULT NULL,
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='权限角色表';
...
CREATE TABLE `fx_user` (
  ...
  `auth_key` char(32) DEFAULT NULL COMMENT '令牌',
  `status` char(1) DEFAULT '1' COMMENT '状态 1正常 0禁用',
  `avatar` varchar(128) DEFAULT NULL COMMENT '头像',
  `creater_id` int(11) DEFAULT '0' COMMENT '创建人id',
...
CREATE TABLE `goods` (
  ...
  `goods_name` varchar(255) NOT NULL COMMENT '商品名称（+规格名称）',
  `gc_id1` int(10) unsigned DEFAULT NULL COMMENT '一级分类id',
  `gc_id2` int(10) DEFAULT '0' COMMENT '二级分类ID',
  `gc_id3` int(10) DEFAULT '0' COMMENT '三级分类ID',
  `gc_id` int(10) NOT NULL DEFAULT '0' COMMENT '最终分类',
  `spec_name` varchar(255) NOT NULL COMMENT '规格名称',
  `goods_spec` text NOT NULL COMMENT '商品规格序列化',
  `promotion_type` tinyint(4) DEFAULT '0' COMMENT '0普通产品 1拼团产品 2秒杀产品',
  `goods_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品价格',
  `goods_costprice` decimal(10,2) DEFAULT NULL,
  `goods_marketprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '市场价',
  `goods_storage_alarm` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '库存报警值',
  ...
  `goods_state` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '商品状态 0下架，1正常，10违规（禁售）',
  `goods_verify` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '商品审核 1通过，0未通过，10审核中',
...
CREATE TABLE `goods_browse` (
  ...
  `goods_commonid` int(11) NOT NULL COMMENT '商品ID',
  `goods_image` varchar(200) DEFAULT NULL,
  `goods_name` varchar(64) DEFAULT NULL,
  `member_id` int(11) NOT NULL COMMENT '会员ID',
  `gc_id` int(11) NOT NULL COMMENT '商品分类',
  `date` varchar(32) NOT NULL COMMENT '浏览日期',
  `views` int(11) DEFAULT '1' COMMENT '当天浏览次数',
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='商品浏览历史表';
...
CREATE TABLE `goods_category` (
  ...
  `type_id` int(11) unsigned DEFAULT '0' COMMENT '规格类型分组id',
  `parent_id` int(11) DEFAULT '0' COMMENT '上级分类',
  `img` varchar(128) DEFAULT NULL COMMENT '分类图片',
  `desc` varchar(64) DEFAULT NULL COMMENT '分类描述',
  `index_menu` char(1) DEFAULT '0' COMMENT '是否显示在手机端首页',
  PRIMARY KEY (`id`)
...
CREATE TABLE `goods_common` (
  ...
  `gc_id1` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '一级分类',
  `gc_id2` int(10) DEFAULT '0' COMMENT '二级分类',
  `gc_id3` int(10) DEFAULT '0' COMMENT '三级分类',
  `gc_id` int(10) DEFAULT '0' COMMENT '最终分类',
  `spec_name` varchar(255) NOT NULL COMMENT '规格名称',
  `spec_value` text NOT NULL COMMENT '规格值',
  `type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '类型id',
  `promotion_type` tinyint(4) DEFAULT '0' COMMENT '0普通产品 1拼团产品 2秒杀产品   一个商品同时只能是一种类型',
  `goods_image` varchar(100) NOT NULL COMMENT '商品主图',
  `goods_storage` int(11) unsigned DEFAULT '0' COMMENT '总库存',
  `goods_salenum` int(11) DEFAULT '0' COMMENT '商品销量',
  `goods_click` int(11) DEFAULT '0' COMMENT '点击量',
  `goods_collect` int(11) DEFAULT '0' COMMENT '收藏量',
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';
...
CREATE TABLE `goods_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COMMENT='商品图片';
...
CREATE TABLE `goods_spec` (
  ...
  `spec_name` varchar(16) NOT NULL COMMENT '规格名称',
...
CREATE TABLE `goods_spec_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';
...
CREATE TABLE `http_log` (
  ...
  `create_at` timestamp NULL DEFAULT NULL COMMENT '请求时间',
  `finish_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '结束时间',
  `full_url` text COMMENT '请求链接',
  `http_status` int(11) DEFAULT '0' COMMENT '请求状态',
  `response` text COMMENT '返回参数',
  `request` text COMMENT '请求参数',
  `ips` varchar(256) DEFAULT '' COMMENT '请求ip',
  `method` varchar(32) DEFAULT '' COMMENT '请求方式',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `member` (
  ...
  `member_mobile` varchar(13) NOT NULL DEFAULT '0' COMMENT '会员电话',
  `loginpwd` char(32) DEFAULT NULL COMMENT '登录密码',
  `paypwd` char(32) DEFAULT NULL COMMENT '支付密码',
  `auth_key` char(32) DEFAULT NULL COMMENT '会员令牌',
  `invite_id` int(11) DEFAULT '0' COMMENT '推荐人',
  `openid` varchar(128) DEFAULT NULL COMMENT '微信openid',
  `member_avatar` varchar(128) DEFAULT NULL COMMENT '用户头像',
  `grade` tinyint(4) DEFAULT '0' COMMENT '用户等级',
  `state` char(1) DEFAULT '1' COMMENT '用户状态 1正常 0冻结',
  `create_time` int(11) DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `member_sms` (
  ...
  `member_id` int(11) NOT NULL COMMENT '会员ID',
  `auth_code` varchar(8) DEFAULT NULL COMMENT '短信/邮件验证码',
  `send_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '短信/邮件验证码发送时间',
  `send_times` tinyint(4) NOT NULL DEFAULT '0' COMMENT '发送手机验证码次数',
  `expire_time` int(11) NOT NULL DEFAULT '0' COMMENT '有效时间',
  PRIMARY KEY (`id`,`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员短信息表';

-- ----------------------------
-- Records of member_sms
-- ----------------------------
...
CREATE TABLE `orders` (
  ...
  `order_type` tinyint(4) DEFAULT '1' COMMENT '订单类型1普通订单(默认),2拼团订单,3秒杀订单,4门店自提订单',
  `order_state` tinyint(4) NOT NULL DEFAULT '1' COMMENT '订单状态：0(已取消)1(默认):未付款;2:已付款;3:已发货;4:已收货;',
  ...
  `pintuan_state` tinyint(4) DEFAULT '0' COMMENT '拼团状态 针对拼团订单 0未付款状态 1拼团中 2拼团完成 3拼团失败，4拼团失败退款完成',
  `join_order_id` int(11) DEFAULT '0' COMMENT '加入的拼团订单id 开团人为0',
  ...
  `shipping_time` int(10) DEFAULT '0' COMMENT '发货时间',
...
CREATE TABLE `order_common` (
  ...
  `shipping_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '配送时间(发货时间)',
  ...
  `reciver_phone` varchar(16) DEFAULT NULL COMMENT '收货人电话',
  ...
  PRIMARY KEY (`id`),
  KEY `ordersid` (`order_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';
...
CREATE TABLE `order_goods` (
  ...
  `goods_type` char(1) NOT NULL DEFAULT '1' COMMENT '1默认 2拼团',
...
CREATE TABLE `pintuan_activity` (
  ...
  `pintuan_image` varchar(128) DEFAULT NULL COMMENT '拼团活动图片',
  `state` char(1) DEFAULT '1' COMMENT '1开启 0关闭',
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='拼团活动（拼团模块）1';
...
CREATE TABLE `pintuan_goods` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `instance_id` int(11) NOT NULL COMMENT '拼团实例id',
  `goods_commonid` int(11) NOT NULL,
  `goods_id` int(11) NOT NULL,
  `pintuan_price` decimal(10,2) NOT NULL COMMENT '拼团价格',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='拼团产品表 3';
...
CREATE TABLE `pintuan_instance` (
  ...
  `title` varchar(32) NOT NULL COMMENT '拼团活动标题',
  `image` varchar(128) DEFAULT '' COMMENT '图片',
  `start_time` int(10) NOT NULL COMMENT '拼团开始时间',
  `end_time` int(10) NOT NULL COMMENT '拼团结束时间',
  `trailer_time` int(10) DEFAULT NULL COMMENT '预告时间',
  `min_nums` tinyint(4) NOT NULL DEFAULT '2' COMMENT '最少开团人数',
  `time_limit` tinyint(4) DEFAULT '60' COMMENT '成团时间限制 在规定时间内完成拼团 否则全都失败 单位：分',
  `state` char(1) DEFAULT '1' COMMENT '1开启 0关闭',
  `end_goods_status` char(1) DEFAULT '1' COMMENT '活动结束后 1 产品变成普通产品 2 下架',
  `is_end` char(1) DEFAULT '0' COMMENT '是否已经结束 1已结束 0未结束',
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`instance_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='拼团活动实例 2';
...
CREATE TABLE `pintuan_member_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `open_order_id` int(11) NOT NULL COMMENT '开团订单id',
  `order_id` int(11) DEFAULT NULL COMMENT '订单id',
  `member_id` int(11) NOT NULL,
  `member_name` varchar(32) DEFAULT NULL,
  `goods_id` int(11) NOT NULL COMMENT '开团的商品',
  `goods_num` tinyint(4) DEFAULT NULL,
  `open_goods_price` decimal(10,2) DEFAULT NULL COMMENT '拼团产品价格',
  `is_open` char(1) DEFAULT '0' COMMENT '是否为开团订单',
  `create_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='拼团会员订单5';

-- ----------------------------
-- Records of pintuan_member_order
-- ----------------------------
...
CREATE TABLE `pintuan_open_order` (
  `open_order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '开团订单id',
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `open_member_id` int(11) NOT NULL COMMENT '开团会员id',
  `instance_id` int(11) DEFAULT NULL COMMENT '实例id',
  `goods_commonid` int(11) DEFAULT NULL,
  `goods_id` int(11) NOT NULL COMMENT '拼团产品',
  `start_time` int(10) NOT NULL COMMENT '开团时间',
  `end_time` int(10) DEFAULT NULL COMMENT '开团结束时间',
  `open_nums` tinyint(4) DEFAULT '2' COMMENT '开团需要的人数',
  `join_nums` tinyint(4) DEFAULT '1' COMMENT '参与拼团人数',
  `join_order_ids` varchar(128) DEFAULT NULL COMMENT '参与的订单id',
  `pay_state` char(1) DEFAULT '0' COMMENT '是否支付 0未支付 1已支付',
  `state` char(1) DEFAULT '1' COMMENT '0拼团失败 1拼团中  2拼团成功 3拼团超时',
  `complete_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`open_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='拼团开团订单4';

-- ----------------------------
-- Records of pintuan_open_order
-- ----------------------------
...
CREATE TABLE `seckill_activity` (
  ...
  `title` varchar(64) DEFAULT NULL COMMENT '活动名称',
  `intro` varchar(128) DEFAULT NULL,
  `seckill_image` varchar(128) DEFAULT NULL COMMENT '秒杀活动图片',
  `state` char(1) DEFAULT '1' COMMENT '1开启 0关闭',
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='秒杀活动/秒杀模块 1';
...
CREATE TABLE `seckill_goods` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `instance_id` int(11) NOT NULL COMMENT '秒杀实例id',
  `goods_commonid` int(11) NOT NULL,
  `goods_id` int(11) NOT NULL,
  `seckill_price` decimal(10,2) NOT NULL COMMENT '秒杀价格',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='秒杀产品表 3';
...
CREATE TABLE `seckill_instance` (
  `instance_id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(32) NOT NULL COMMENT '秒杀活动标题',
  `image` varchar(128) DEFAULT '' COMMENT '图片',
  `start_time` int(10) NOT NULL COMMENT '秒杀开始时间',
  `end_time` int(10) NOT NULL COMMENT '秒杀结束时间',
  `trailer_time` int(10) DEFAULT NULL COMMENT '预告时间',
  `state` char(1) DEFAULT '1' COMMENT '1开启 0关闭',
  `end_goods_status` char(1) DEFAULT '1' COMMENT '活动结束后 1 产品变成普通产品 2 下架',
  `is_end` char(1) DEFAULT '0' COMMENT '是否已经结束 1已结束 0未结束',
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`instance_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='秒杀活动实例 2';
...
CREATE TABLE `sms_log` (
  ...
  `captcha` char(6) NOT NULL COMMENT '短信验证码',
  `ip` varchar(15) NOT NULL COMMENT '请求IP',
  `msg` varchar(300) NOT NULL COMMENT '短信内容',
  `type` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '短信类型:1为注册,2为登录,3为找回密码,默认为1',
  `res` varchar(128) DEFAULT NULL COMMENT '发送结果',
...
CREATE TABLE `spec_type_group` (
  ...
  `type_name` varchar(64) DEFAULT NULL COMMENT '分组名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='规格类型分组表（将规格分组）';
...
CREATE TABLE `type_spec` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `type_id` int(11) NOT NULL DEFAULT '0' COMMENT '规格分组ID',
  `spec_id` int(11) DEFAULT '0' COMMENT '规格ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='规格类型表 (规格分组中对应的规格)';
